  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const patientData = {
        ...
        nextOfKin: {
          name: n.nokName,
          phoneNumber: n.nokPhone,
          relationship: n.nokRelationship,
        },
        ...
        insurance: ins.insuranceProvider
          ? {
              ...
              expiryDate: insuranceExpiryDate
                ? format(insuranceExpiryDate, "yyyy-MM-dd")
                : undefined,
            }
          : undefined,
      };

      await apiService.patients.completeProfile(patientData);

      toast({
        title: "Profile Completed! ✅",
        description: "Your patient profile is approved.",
      });
      if (isAddingRole) {
    ...
    <div className="flex min-h-screen bg-background">
      <div className="mx-auto w-full max-w-2xl px-4 py-8">
        <h1 className="mb-1 text-2xl font-bold text-foreground">
          {isAddingRole ? "Patient Profile Setup" : "Complete Your Profile"}
        </h1>
        <p className="mb-6 text-sm text-muted-foreground">
          {isAddingRole
            ? "Set up your patient profile to access healthcare services"
            : "Fill in your details to get started with WellBank"}
        </p>
                  ...
                  render={({ field }) => (
                    ...
                    >
                      <SelectTrigger className="mt-1">
                        <SelectValue
                          placeholder={
                            watchState && STATE_LGAS[watchState]
                              ? "Select LGA"
                              : "Select state first"
                          }
                        />
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                {...nokForm.register("nokName")}
              />
              {nokForm.formState.errors.nokName && (
                <p className="mt-1 text-xs text-destructive">
                  {nokForm.formState.errors.nokName.message}
                </p>
              )}
            </div>
            <div>
              ...
              <Input
                className="mt-1"
                placeholder="+234..."
                {...nokForm.register("nokPhone")}
              />
              {nokForm.formState.errors.nokPhone && (
                <p className="mt-1 text-xs text-destructive">
                  {nokForm.formState.errors.nokPhone.message}
                </p>
              )}
            </div>
            <div>
        ...
        {step === 4 && (
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Add your health insurance details if you have one
            </p>
            <div>
            ...
            <FileUpload
              ...
              value={insuranceCardFile}
              onChange={setInsuranceCardFile}
        ...
        {step === 5 && (
          <div className="space-y-4">
            ...
            <FileUpload
              ...
              description="Required for Voter's Card, Driver's License"
            />
          </div>
        )}
